...
def read_route(input_file):
    ...
    for index,row in data.iterrows():
        ...
        sec = Section(index, speed, slope, slope_percent, distance, duration, acceleration, bus_stop)
        sections.append(sec)
    ...
    print("Total Route kms: {}".format(total_kms))
    route = Route(1, sections)

    return route, total_kms
