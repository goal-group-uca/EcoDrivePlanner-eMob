...
from jmetal.util.solution import print_function_values_to_file, print_variables_to_file, print_constraint_values_to_file
        ...
        if solutions:
            if isinstance(problem, DynamicProblem):
                ...
                if termination_criterion_is_met:
                    ...
                    # print_constraint_values_to_file(solutions, '{}/CONS.{}'.format(self.directory, self.counter))
                    self.counter += 1
            else:
                print_function_values_to_file(solutions, '{}/FUN.{}'.format(self.directory, self.counter))
                print_variables_to_file(solutions, '{}/VAR.{}'.format(self.directory, self.counter))
